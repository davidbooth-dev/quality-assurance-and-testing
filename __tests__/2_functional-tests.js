...
suite("Functional Tests", function() {
  ...
  suite("Integration tests with chai-http", function() {
    ...
    suite('GET /hello?name=[name] => "hello [name]"', function() {
      ...
      test("Test GET /hello with your name", function(done) {
        ...
        chai
          .request(server) // 'server' is the Express App
          .get("/hello?name=David") /** <=== Put your name in the query **/
          .end(function(err, res) {
            // res is the response object
            ...
            assert.equal(
              res.text,
              "hello David",
              "response text should equal david"
            );
            done(); // Always call the 'done()' callback when finished.
          });
      });
      ...
      test('#example - responds with appropriate JSON data when sending {surname: "Polo"}', function(done) {
        chai
          ...
          .end(function(err, res) {
            ...
            assert.equal(res.body.dates, "1254 - 1324");
            // call 'done()' when... done
            done();
          });
      });
  ...
  Browser.site = "https://oil-pleasant-edge.glitch.me";
